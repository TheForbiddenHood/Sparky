...
If you're looking for how to turn on the bot, you'll need to use '**node deploy-commands.js**' to send your slash commands to Discord. After you've done that makes sure to get the magic started by typing in '**node app.js**'. Of course, these will only work with the correct imports, and files in place. Remember, not *ALL* files Sparky uses are included in this repo (mostly for data privacy)
