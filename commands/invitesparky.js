...
module.exports = {
    ...
    async execute(interaction){
        ...
        .setColor('#800080')
        .setDescription(`
            I appreciate the thought! You can invite me by clicking [here](https://discord.com/oauth2/authorize?client_id=1419423775560306708&permissions=885863330&integration_type=0&scope=bot) 🎉
            `)
